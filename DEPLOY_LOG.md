...
### **Repositório:** https://github.com/admVeloHub/Console-v2-gcp.git
### **Commit:** *(tip `main` = último commit em `origin/main`; ver `git log -1` após sincronizar)*
...
**Nota:** A sessão com `_funcoesAdministrativas` no login (`LoginPage.jsx` v3.6.1) já constava no branch antes deste push.
